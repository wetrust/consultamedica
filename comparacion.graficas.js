...
function mostrarValoresEnModal(datos) {
    ...
    for (let i = 0; i < datos['Edad Gestacional'].length; i++) {
        ...
        leyenda += '<tr><td scope="row" class="text-center" style="background-color: #e9ecef;">'+_laEG+'</td><td class="text-center" style="background-color: #e9ecef;">'+ pfe +'</td><td class="text-center" style="background-color: #e9ecef;">'+ umbilicalPct +'</td><td class="text-center">'+ cmediaPct +'</td><td class="text-center" style="background-color: #e9ecef;">'+ cplacentarioPct +'</td><td class="text-center">'+ uterinasPct +'</td></tr>'
...
function informeComparacion(){
    ...
    _informe.innerHTML = '<h4 class="text-center">Evolución percentil de Peso Fetal Estimado y Flujometría Doppler Materno/Fetal</h4><span class="mt-2" style="border-top:1px solid #000;width:100%!important;display:block;padding-top:2px"></span><div class="mt-2 row"><div class="col-4"><p style="font-size:13px"><strong>Nombre: </strong><span id="paciente"></div><div class="col-4"><p style="font-size:13px"><strong>RUT: </strong><span id="rut"></span></div></div><div class="row"><div class="col-12"><div id="graficoUno"></div></div><div class="col-12"><div class="row" id="graficoDos"></div></div></div><div class="row pt-5" id="lineclear"><div class="col-12"><h6>Tabla percentiles de PFE más Indice de pulsatilidad (IP) de Doppler UMB, ACM, CCP y uterinas promedio</h6></div><div class="col-12" id="tablaDatos"></div></div>'
