...
function informeComparacion()
{
    ...
    _informe.innerHTML += '<hr><div class="row mt-4"><div class="col-6"><p style="font-size: 15px"><strong>Fecha de Impresion: </strong><span id="fechaImpresion"></span></p></div><div class="col-6"><p style="font-size: 15px"><strong>Ecografista: </strong><span id="examinador"></span></p></div></div>';
