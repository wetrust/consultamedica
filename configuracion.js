...
$(document).ready(function() {
    ...
    guardar += '<ul class="mt-5"><li>Configuración de plataforma en su navegador se guarda de forma temporal, si desea guardar configuración de forma permanente escriba su email y presione <strong>boton guardar</strong>.</li><li>Para restaurar configuración guardada anteriormente, presione restaurar <strong>configuración</strong>.</li><li>Recuerde una vez guardada su configuración si realiza cambios, debe nuevamente <strong>guardar configuración</strong>.</li></ul>'
