	...
	if (window.localStorage) {
		if (typeof localStorage.pacientes == 'undefined') {
			$.getJSON( "assets/json/base.json", function( data ) {
				...
				paciente[0].RUT = $("#id-paciente").val();
