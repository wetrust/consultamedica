...
$( '#modalPreInfEcoObsSegTrim2' ).on( 'click', function() {
	...
	$( '#impDoppler2').remove();
	$( '#impDoppler1').remove();
        $('#popupBody').html("<div class='form-group'> <label>Presentaci&oacute;n</label> <select id='presentacion' class='form-control'> <option value='cefalica'>Cef&aacute;lica</option> <option value='podalica'>Pod&aacute;lica</option> <option value='transversa'>transversa</option> <option value='indiferente'>indiferente</option> </select></div><div class='form-group'> <label>Dorso Fetal</label> <select id='dorso' class='form-control'> <option value='anterior'>Anterior</option> <option value='lateral izquiedo'>Lat. Izquierdo</option> <option value='posterior'>Posterior</option> <option value='lateral derecho'>Lat. Derecho</option> </select></div><div class='form-group'> <label>Actividada Cardiaca</label></div><div class='form-group'> <div class='form-check form-check-inline'> <label class='form-check-label'> <input class='form-check-input' type='radio' checked='checked' name='accard' value='1'> Si</label> </div><div class='form-check form-check-inline'> <label class='form-check-label'> <input class='form-check-input' type='radio' name='accard' value='0'> No</label> </div></div><div class='form-group'> <label>Mov. Fetales</label></div><div class='form-group'> <div class='form-check form-check-inline'> <label class='form-check-label'> <input class='form-check-input' type='radio' checked='checked' name='movfet' value='1'> Si</label> </div><div class='form-check form-check-inline'> <label class='form-check-label'> <input class='form-check-input' type='radio' name='movfet' value='0'> No</label> </div></div><div class='form-group'> <label>FCF</label> <select id='fcf' class='form-control'> <option value='90'>90</option> <option value='91'>91</option> <option value='92'>92</option> <option value='93'>93</option> <option value='94'>94</option> <option value='95'>95</option> <option value='96'>96</option> <option value='97'>97</option> <option value='98'>98</option> <option value='99'>99</option> <option value='100'>100</option> <option value='101'>101</option> <option value='102'>102</option> <option value='103'>103</option> <option value='104'>104</option> <option value='105'>105</option> <option value='106'>106</option> <option value='107'>107</option> <option value='108'>108</option> <option value='109'>109</option> <option value='110'>110</option> <option value='111'>111</option> <option value='112'>112</option> <option value='113'>113</option> <option value='114'>114</option> <option value='115'>115</option> <option value='116'>116</option> <option value='117'>117</option> <option value='118'>118</option> <option value='119'>119</option> <option value='120'>120</option> <option value='121'>121</option> <option value='122'>122</option> <option value='123'>123</option> <option value='124'>124</option> <option value='125'>125</option> <option value='126'>126</option> <option value='127'>127</option> <option value='128'>128</option> <option value='129'>129</option> <option value='130'>130</option> <option value='131'>131</option> <option value='132'>132</option> <option value='133'>133</option> <option value='134'>134</option> <option value='135'>135</option> <option value='136'>136</option> <option value='137'>137</option> <option value='138'>138</option> <option value='139'>139</option> <option selected='selected' value='140'>140</option> <option value='141'>141</option> <option value='142'>142</option> <option value='143'>143</option> <option value='144'>144</option> <option value='145'>145</option> <option value='146'>146</option> <option value='147'>147</option> <option value='148'>148</option> <option value='149'>149</option> <option value='150'>150</option> <option value='151'>151</option> <option value='152'>152</option> <option value='153'>153</option> <option value='154'>154</option> <option value='155'>155</option> <option value='156'>156</option> <option value='157'>157</option> <option value='158'>158</option> <option value='159'>159</option> <option value='160'>160</option> <option value='161'>161</option> <option value='162'>162</option> <option value='163'>163</option> <option value='164'>164</option> <option value='165'>165</option> <option value='166'>166</option> <option value='167'>167</option> <option value='168'>168</option> <option value='169'>169</option> <option value='170'>170</option> </select></div><div class='form-group'> <label>Anatom&iacute;a fetal</label> <select multiple id='ev-morfo' class='form-control'> <option selected='selected' value='no evaluada dirigidamente, pero el aspecto morfológico general es normal'>No evaluada dirigidamente, pero el aspecto morfológico general es normal</option> <option value='de aspecto general normal'>De aspecto general normal</option> <option value='alteraciones de cr&aacute;neo'>Alteraciones de cr&aacute;neo</option> <option value='alteraciones de columna'>Alteraciones de columna</option> <option value='alteraciones de t&oacute;rax'>Alteraciones de t&oacute;rax</option> <option value='alteraciones de coraz&oacute;n'>Alteraciones de coraz&oacute;n</option> <option value='alteraciones de abdomen'>Alteraciones de abdomen</option> <option value='alteraciones de ri&ntilde;ones'>Alteraciones de ri&ntilde;ones</option> <option value='alteraciones de vejiga'>Alteraciones de vejiga</option> <option value='alteracion extemidades'>Alteracion extemidades</option> <option value='alteraciones m&uacute;ltiples'>Alteraciones m&uacute;ltiples</option> </select></div><div class='form-group'> <p><strong>Comentarios anatom&iacute;a</strong> </p><textarea id='comentarios-anatomia-informe-eg-texto' class='form-control' rows='3'></textarea></div><div class='row'> <div class='col'> <div class='form-group'> <label>Placenta Ubicaci&oacute;n</label> <select id='ubicacion' class='form-control'> <option value='normal'>Normal</option> <option value='prev. lateral'>previa lateral</option> <option value='prev. marginal'>previa marginal</option> <option value='prev. parcial'>previa parcial</option> <option value='prev. total'>previa total</option> </select> </div></div><div class='col'> <div class='form-group'> <label>Placenta incersi&oacute;n</label> <select id='incersion' class='form-control'> <option value='anterior'>anterior</option> <option value='posterior'>posterior</option> <option value='fundica'>f&uacute;ndica</option> <option value='lat. derecha'>lateral derecha</option> <option value='lat. izquierda'>lateral izquierda</option> <option value='segmentaria'>segmentaria</option> </select> </div></div><div class='col'> <div class='form-group'> <label>Placenta Grado (Grannum)</label> <select id='grado-placenta' class='form-control'> <option value='0'>0</option> <option value='1'>1</option> <option value='2'>2</option> <option value='3'>3</option> </select> </div></div></div><div class='row'> <div class='col'> <div class='form-group'> <label>Líquido amniótico</label> <select id='liq-cualitativo-eco' class='form-control'> <option value='normal'>Normal</option> <option value='disminuido'>Disminuido</option> <option value='aumentado'>Aumentado</option> </select> </div></div><div class='col'> <div class='form-group'> <label>BVM</label> <div class='input-group mb-2 mr-sm-2 mb-sm-0'> <input type='text' class='form-control' id='bvmEcoDos'> <div class='input-group-addon'>mm.</div></div></div></div></div><div class='row'> <div class='col'> <div class='form-group'> <label>Cord&oacute;n umbilical</label> <select id='cordon' class='form-control'> <option value='inserci&oacute;n central'>Inserci&oacute;n central</option> <option value='inserci&oacute;n marginal'>Inserci&oacute;n marginal</option> <option value='inserci&oacute;n velamentosa'>Inserci&oacute;n velamentosa</option> <option value='inserci&oacute;n no evaluable'>Inserci&oacute;n no evaluable</option> </select> </div></div><div class='col'> <div class='form-group'> <label>N&uacute;mero de vasos</label> <select id='vasos' class='form-control'> <option value='2'>2</option> <option selected='selected' value='3'>3</option> </select> </div></div></div><div class='form-group'> <p><strong>Comentarios adicionales</strong> </p><textarea id='comentarios-eco-dos-inf-dos' rows='3' class='form-control'></textarea></div>");
	//añadir boton de imprimir
	var p50 = $('#egP50').val();
	var fur = $( "input[name='fum']").val();
	var fpp = $( "input[name='fpp']").val();
	var comentario = "Edad ecográfica (Bp50): " + p50 + " Semanas, ( La Biometría p50 no incluye el perímetro abdominal )\r\nFum operacional: " + fur + "\r\nFecha probable de parto: " + fpp + "\r\n" + $('#comentarios-eco-dos-generico').val();
...
$( '#modalPreInfEcoDoppler' ).on( 'click', function() {
	...
	var comentarios = "";
	if ($('#auprom').val() > 0){
		comentarios = 'Flujometria doppler materno promedio de uterinas IP ' + parseInt($('#auprom').val()) + '\r\n';
	}
	if ($('#ipau').val() > 0){
...
function crearInformeEcoSegTrim1(){
	...
	for(i=0;i<anatomiaFetal.length;i++)
        ...
        var linea3 = "<strong style='color:#098dff;'>Anatomía fetal *</strong>  " + anatomiaFetalString + $('#comentarios-anatomia-informe-eg-texto').val();
        var linea4 = "<strong style='color:#098dff;'>Placenta</strong> inserción " + document.getElementById("incersion").value + " y de ubicación " + document.getElementById("ubicacion").value + ", grado " + document.getElementById("grado-placenta").value;
        var linea5 = "<strong style='color:#098dff;'>Cordón umbilical</strong> " + document.getElementById("cordon").value + ", identificandose "+ document.getElementById("vasos").value +" vasos.";
        var linea6 = "<strong style='color:#098dff;'>Líquido amniótico **</strong>" + $('#liq-cualitativo-eco').val() + ", con bolsillo vertical mayor de " + document.getElementById("bvm").value + " mm" + ilatxt;
	...
	var comentario = $('#comentarios-eco-dos-inf-uno').val().replace(/\r\n|\r|\n/g,"<br />");
	var edadmaterna = $( "input[name='edad_materna']").val();
	
	var InformeString = "<span style='border-top: 1px solid #000;width: 100% !important;display: block;border-bottom: 2px solid #000;padding-top: 2px;'></span><h3>Evaluación ecográfica del crecimiento fetal</h3><div class='container'> <p><strong style="color:#098dff;">Paciente Sra. (Srta.): </strong>:PACIENTE<strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Fecha de Exámen: </strong>:FEXAMEN&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>Edad Materna: </strong> :EDADMATERNA años.</p><p><strong style="color:#098dff;"> ID Paciente: </strong>:IDPACIENTE<strong> Motivo: </strong>:MOTIVO</p><p><strong style="color:#098dff;">FUM: </strong>:FUR <br><strong style="color:#098dff;">Ege: </strong>:EG semanas <br><strong style="color:#098dff;">FPP: </strong>:FPP</p></div><div class='container'> <p><strong style="color:#098dff;">DESCRIPCIÓN</strong> </p><p style='margin-bottom:0;'>:LINEA1 <br>:LINEA2</p><p style='margin-bottom:0; word-wrap: break-word;'>:LINEA3</p><p>:LINEA4 <br>:LINEA5 <br>:LINEA6</p><p></p><p></p></div><div class='container'> <table class='table'> <tbody> <tr> <th style="color:#098dff;">Biometrías</th> <th style='text-align:center;'>Valor observado (mm)</th> <th class='text-center'>Percentil de Crecimiento</th> <th class='text-center'>Referencia para Edad</th> </tr><tr> <td>DBP (Hadlock):</td><td style='text-align:center;'>:DBP</td><td class='text-center'>:DBPPCT</td><td class='text-center'>:DBPRANGO</td></tr><tr> <td>DOF (Jeanty):</td><td style='text-align:center;'>:DOF</td><td class='text-center'>:DOFPCT</td><td class='text-center'>:DOFRANGO</td></tr><tr> <td>CC (Hadlock):</td><td style='text-align:center;'>:CC</td><td class='text-center'>:CCPCT</td><td class='text-center'>:CCRANGO</td></tr><tr> <td>CA (Hadlock):</td><td style='text-align:center;'>:CA</td><td class='text-center'>:CAPCT</td><td class='text-center'>:CARANGO</td></tr><tr> <td style='padding-bottom: 15px !important;'>LF (Hadlock):</td><td style='text-align:center;padding-bottom: 15px !important;'>:LF</td><td style='text-align:center;padding-bottom: 15px !important;'>:LFPCT</td><td style='text-align:center;padding-bottom: 15px !important;'>:LFRANGO</td></tr><tr> <td style='border-top:1px dashed #098dff;'>Peso Fetal Estimado según fórmula de Hadlock (DBP-CC-CA-LF)</td><td style='text-align:center;border-top:1px dashed #098dff;'>:PFE</td><td style='text-align:center;border-top:1px dashed #098dff;'>:PFEPCT</td><td style='text-align:center;border-top:1px dashed #098dff;'>:PFERANGO</td></tr><tr> <td style='border-top:1px dashed #000;'>Relación CC / CA (Hadlock)</td><td class='text-center' style='border-top:1px dashed #098dff;'>:CCCA</td><td class='text-center' style='border-top:1px dashed #098dff;'>:CCCAPCT</td><td class='text-center' style='border-top:1px dashed #098dff;'>:CCCARANGO</td></tr><tr> <td>Indice Cefálico (DBP / DOF)</td><td style='text-align:center;'>:IC</td><td></td><td class='text-center'>( 70% - 86% )</td></tr><tr> <td></td><td></td><td></td><td></td></tr></tbody> </table></div><div class='container'> <p><strong style="color:#098dff;">COMENTARIOS Y OBSERVACIONES</strong> <small>(Debe ser completado por el ecografista)</small></p><p style='max-width: 700px;text-align: justify;'>:COMENTARIO</p></div><div class='container'> <p class='text-right top40' style='margin-right:100px;'>Ecografista Dr(a): <strong>:ECOGRAFISTA</strong> </p><span style='border-top: 1px solid #000;width: 100% !important;display: block;'></span> <p>Fecha Informe: :DATEINFORME</p><span style='border-top: 2px solid #000;width: 100% !important;display: block;'></span> <p class='pie-pagina' style='margin-bottom:0;'><strong>* Para la evaluación morfológica fetal, ceñirse a recomendaciones oficiales vigentes, para Chile: Guías Perinatales MINSAL 2015</strong> <br>Ver dirección web: http://web.minsal.cl/sites/default/files/files/GUIA%20PERINATAL_2015_%20PARA%20PUBLICAR.pdf <br>** Referencia para medición de líquido amniótico (BVM), Magann EF. Sanderson M. Martin JN y col. Am J Obstet Gynecol 1982: 1581, 2000<br>*** Evaluación de crecimiento fetal (Gráfica), según referencia propuesta por Hadlock y col. Radiology 181: 129 - 133; 1991 (Normalidad Pct 10 a 90)</p><p style='margin-bottom:0 !important;' class='pie-pagina-dos'><strong>Herramienta informática diseñada por Dr. Rudecindo Lagos S. Médico gineco-obstetra ultrasonografista y Cristopher Castro G. Ingenieria Civil.<br>Este software tiene por objetivo favorecer el análisis preliminar de los datos obtenidos en el exámen ecográfico, la interpretación clínica de los mismos, es responsabilidad exclusiva de quien realiza y certifica este documento.</strong> </p></div>";
...
function crearInformeEcoSegTrim2(){
	...
	var InformeString = "<span style='border-top: 1px solid #000;width: 100% !important;display: block;border-bottom: 2px solid #000;padding-top: 2px;'></span><h3>Determinación Ecográfica (Tardía) de la Edad Gestacional</h3><div class='container'> <p><strong>Paciente Sra. (Srta.): </strong>:PACIENTE<strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Fecha de Exámen: </strong>:FEXAMEN&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>Edad Materna: </strong> :EDADMATERNA años.</p><p><strong>ID Paciente: </strong>:IDPACIENTE <strong>Motivo: </strong>:MOTIVO</p><p><strong>FUM: </strong> :FUR <br><strong>EG (UPM): </strong> :EG semanas</p></div><div class='container'> <p><strong>DESCRIPCIÓN</strong> </p><p style='margin-bottom:0;'>:LINEA1 <br>:LINEA2</p><p style='margin-bottom:0; word-wrap: break-word;'>:LINEA3</p><p>:LINEA4 <br>:LINEA5 <br>:LINEA6</p><p></p><p></p></div><div class='container-fluid'> <table class='table'> <tbody> <tr> <th style='line-height:15px !important;'>Biometrías</th> <th style='text-align:center;'>Valor observado (mm)</th> <th style='text-align:center;'>Referencia para Edad</th> </tr><tr> <td>DBP (Hadlock):</td><td style='text-align:center;'>:DBP</td><td style='text-align:center;'>:DBPRANGO</td></tr><tr> <td>DOF (Jeanty):</td><td style='text-align:center;'>:DOF</td><td style='text-align:center;'>:DOFRANGO</td></tr><tr> <td>CC (Hadlock):</td><td style='text-align:center;'>:CC</td><td style='text-align:center;'>:CCRANGO</td></tr><tr> <td>CA (Hadlock):</td><td style='text-align:center;'>:CA</td><td style='text-align:center;'>:CARANGO</td></tr><tr> <td>LF (Hadlock):</td><td style='text-align:center;'>:LF</td><td style='text-align:center;'>:LFRANGO</td></tr><tr> <td>LH (Jeanty):</td><td style='text-align:center;'>:LH</td><td style='text-align:center;'>:LHRANGO</td></tr><tr> <td>Cerebelo (Diámetro transverso) (Hill):</td><td style='text-align:center;'>:CB</td><td style='text-align:center;'>:CBRANGO</td></tr><tr> <td>Indice Cefálico (DBP / DOF)</td><td style='text-align:center;'>:IC</td><td style='text-align:center;'>( 70% - 86% )</td></tr><tr> <td>Relación CC / CA (Hadlock)</td><td style='text-align:center;'>:CCCA</td><td style='text-align:center;'>:CCCARANGO</td></tr><tr> <td></td><td></td><td></td></tr></tbody> </table></div><div class='container-fluid'> <p><strong>COMENTARIOS Y OBSERVACIONES</strong> <small>(Debe ser completado por el ecografista)</small></p><p style='max-width: 700px;text-align: justify;'>:COMENTARIO</p></div><div class='container-fluid'> <p class='text-right top40' style='margin-right:100px;'>Ecografista Dr(a): <strong>:ECOGRAFISTA</strong> </p><span style='border-top: 1px solid #000;width: 100% !important;display: block;'></span> <p>Fecha Informe: :DATEINFORME</p><span style='border-top: 2px solid #000;width: 100% !important;display: block;'></span> <p class='pie-pagina' style='margin-bottom:0;'><strong>* Para la evaluación morfológica fetal, ceñirse a recomendaciones oficiales vigentes, para Chile: Guías Perinatales MINSAL 2015</strong> <br>Ver dirección web: http://web.minsal.cl/sites/default/files/files/GUIA%20PERINATAL_2015_%20PARA%20PUBLICAR.pdf <br>** Referencia para medición de líquido amniótico (BVM), Magann EF. Sanderson M. Martin JN y col. Am J Obstet Gynecol 1982: 1581, 2000</p><p style='margin-bottom:0 !important;' class='pie-pagina-dos'><strong>Herramienta informática diseñada por Dr. Rudecindo Lagos S. Médico gineco-obstetra ultrasonografista y Cristopher Castro G. Ingenieria Civil.<br>Este software tiene por objetivo favorecer el análisis preliminar de los datos obtenidos en el exámen ecográfico, la interpretación clínica de los mismos, es responsabilidad exclusiva de quien realiza y certifica este documento.</strong> </p></div>";

	var comentario = $('#comentarios-eco-dos-inf-dos').val().replace(/\r\n|\r|\n/g,"<br />");
...
function crearInformeDoppler(){
	...
	var InformeString = "<span style='border-top: 1px solid #000;width: 100% !important;display: block;border-bottom: 2px solid #000;padding-top: 2px;'></span><h3>Evaluación de flujometria doppler materno fetal</h3><div class='container'> <p><strong>Paciente Sra. (Srta.): </strong>:PACIENTE<strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Fecha de Exámen: </strong>:FEXAMEN&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>Edad Materna: </strong> :EDADMATERNA años.</p><p><strong>ID Paciente: </strong>:IDPACIENTE <strong>Motivo: </strong>:MOTIVO</p><p><strong>FUM: </strong> :FUM <br><strong>Ege: </strong> :EG semanas <br><strong>FPP: </strong> :FPP</p></div><div class='container'> <p><strong>Antecedentes, descripción general del feto y anexos ovulares</strong> </p><p>Motivo del exámen: :MOTIVODOPPLER <br>Antecedentes Obstétricos: :ANTECEDENTES <br>Feto en Presentación: :PRESENTACION <br>Motilidad Fetal: :MOTILIDAD <br>Ubicación Placentaria: :UBICACION <br>Líquido Amniótico***: :LIQUIDO <br>Medida única de BVM***: :BVM</p></div><div class='container'> <table class='table'> <thead> <tr> <th>Flujometrías</th> <th style='text-align:right;'>Medidas</th> <th style='text-align:right;'>IP Referencia para E.G.</th> <th style='text-align:right;'>Percentiles de IP</th> </tr></thead> <tbody> <tr> <td>Arteria Uterina Derecha*</td><td style='text-align:right;'>:UD</td><td style='text-align:right;'>:UDRGO</td><td style='text-align:right;'>:UDTXT</td></tr><tr> <td>Arteria Uterina Izquierda*</td><td style='text-align:right;'>:UI</td><td style='text-align:right;'>:UIRGO</td><td style='text-align:right;'>:UITXT</td></tr><tr> <td>Prom. Arterias Uterinas*</td><td style='text-align:right;'>:UPROM</td><td style='text-align:right;'>:UPROMRGO</td><td style='text-align:right;'>:UPROMTXT</td></tr><tr> <td style='border-top: 1px dashed #000;'>Arteria Umbilical**</td><td style='text-align:right;border-top: 1px dashed #000;'>:AU</td><td style='text-align:right;border-top: 1px dashed #000;'>:AURGO</td><td style='text-align:right;border-top: 1px dashed #000;'>:AUTXT</td></tr><tr> <td>Arteria Cerebral Media**</td><td style='text-align:right;'>:ACM</td><td style='text-align:right;'>:ACMRGO</td><td style='text-align:right;'>:ACMTXT</td></tr><tr> <td></td><td></td><td></td><td></td></tr><tr> <td>Cuociente Cerebro Placentario ( CCP )**</td><td style='text-align:right;'>:CCP</td><td style='text-align:right;'>:CCPRGO</td><td style='text-align:right;'>:CCPTXT</td></tr><tr> <td></td><td></td><td></td><td></td></tr></tbody> </table></div><div class='container'> <p><strong>Comentarios y observaciones</strong> </p><p style='max-width: 700px;text-align: justify;'>:COMENTARIO</p></div><div class='container'> <p class='text-right top40' style='margin-right:100px;'>Ecografista Dr(a): :ECOGRAFISTA</p><span style='border-top: 1px solid #000;width: 100% !important;display: block;'></span> <p>Fecha Informe: :DATEINFORME</p><span style='border-top: 2px solid #000;width: 100% !important;display: block;'></span> <p class='pie-pagina'>* Referencia para Doppler promedio de arterias uterinas: Gómes O., Figueras F., Fernandez S., Bennasar M, Martínez JM., Puerto B., Gratacos E., UOG 2008; 32: 128-32 <br>** Referencia para Doppler de arteria umbilical, C Media y CCP; Baschat et al Ultrasound Obstet. Gynecol 2003; 21 124 - 127 <br>*** Referencia para Liq. Amniotico BVM, Magann EF. Sanderson M. Martin JN y col. Am J Obstet Gynecol 1982: 1581, 2000</p><p class='pie-pagina-dos'><strong>Herramienta informática diseñada por Dr. Rudecindo Lagos S. Médico gineco-obstetra ultrasonografista y Cristopher Castro G. Ingenieria Civil.<br>Este software tiene por objetivo favorecer el análisis preliminar de los datos obtenidos en el exámen ecográfico, la interpretación clínica de los mismos,<br>es responsabilidad exclusiva de quien realiza y certifica este documento.</strong> </p></div>";
