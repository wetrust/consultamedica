...
$( '#modalPreInfEcoObsSegTrim1' ).on( 'click', function() {
	...
	$('#ev-morfo').on('change', function(){
		if ($(this).val() == "descripcion extendida"){
