...
$( '#mensajeRestringido' ).on( 'click', function() {
	$('#popupTitle').html("<small>Sección restringida, solo está disponible para usuarios capacitados en la plataforma.</small>");
