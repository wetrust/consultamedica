...
$(document).ready(function(){
	...
	$("#imagen\\.oculta\\.trigger").on("click", function(){
		$("#imagen\\.oculta\\.uno").fadeIn( 400 ).delay( 3000 ).fadeOut( 400 );
		$("#imagen\\.oculta\\.dos").delay( 800 ).fadeIn( 400 ).delay( 3000 ).fadeOut( 400 );
		$("#imagen\\.oculta\\.tres").delay( 1200 ).fadeIn( 400 ).delay( 3000 ).fadeOut( 400 );
