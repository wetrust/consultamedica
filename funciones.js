...
$( '#mensajeRestringido' ).on( 'click', function() {
	...
	$( '#impDoppler1').remove();
	$( '#impDoppler1').remove();
        $('#popupBody').html("<p>Esta sección está restringida, solo está disponible para usuarios capacitados en la plataforma. </p><form><div class='row'><div class='form-group col'> <label for='exampleInputEmail1'>Nombre, Apellido</label> <input type='email' class='form-control' id='exampleInputEmail1'> </div><div class='form-group col'> <label for='exampleInputEmail1'>DNI o RUT</label> <input type='email' class='form-control' id='exampleInputEmail1'> </div></div><div class='row'><div class='form-group col'> <label for='exampleInputEmail1'>Nacionalidad</label> <input type='email' class='form-control' id='exampleInputEmail1'> </div><div class='form-group col'> <label for='exampleSelect1'>Profesión</label> <select class='form-control' id='exampleSelect1'> <option>Médico con especialidad en perinatología</option> <option>Médico con especialidad en gineco-obstetricia</option> <option>Médico sin especialidad en gineco-obstetricia</option> <option>Médico en formación de la especialidad</option> <option>Otros, ultrosonografistas gineco - obstétrico</option> </select> </div></div><div class='row'><div class='form-group col'> <label for='exampleInputEmail1'>Año de título profesional</label> <input type='email' class='form-control' id='exampleInputEmail1'> </div><div class='form-group col'> <label for='exampleInputEmail1'>Registro Médico de especialidad</label> <input type='email' class='form-control' id='exampleInputEmail1'> </div></div><div class='row'><div class='form-group col'> <label for='exampleInputEmail1'>Años de experiencia en US Obstétrico</label> <input type='email' class='form-control' id='exampleInputEmail1'> </div><div class='form-group col'> <label for='exampleInputEmail1'>Lugar de trabajo</label> <input type='email' class='form-control' id='exampleInputEmail1'> </div></div><div class='row'><div class='form-group col'> <label for='exampleInputEmail1'>Ciudad</label> <input type='email' class='form-control' id='exampleInputEmail1' aria-describedby='emailHelp'> </div><div class='form-group col'> <label for='exampleInputEmail1'>Teléfono de contacto</label> <input type='number' class='form-control' id='exampleInputEmail1' aria-describedby='emailHelp'> <small id='emailHelp' class='form-text text-muted'>Nunca compartiremos tu correo con terceros</small> </div></div><div class='form-group'> <label for='exampleInputEmail1'>Correo electrónico</label> <input type='email' class='form-control' id='exampleInputEmail1'> </div><div class='row'><div class='form-group col'> <label for='exampleInputEmail1'>Servicio de salud</label> <div class='form-control'> <div class='form-check form-check-inline'> <label class='form-check-label'> <input class='form-check-input' type='radio' name='inlineRadioOptions' id='inlineRadio1' value='option1' checked='checked'>NO</label></div><div class='form-check form-check-inline'> <label class='form-check-label'> <input class='form-check-input' type='radio' name='inlineRadioOptions' id='inlineRadio2' value='option2'>SI</label></div></div><input type='email' class='form-control d-none' id='exampleInputEmail1'> </div><div class='form-group col'> <label for='exampleInputEmail1'>Hospital</label> <div class='form-control'> <div class='form-check form-check-inline'> <label class='form-check-label'> <input class='form-check-input' type='radio' name='inlineRadioOptions' id='inlineRadio1' value='option1' checked='checked'>NO</label></div><div class='form-check form-check-inline'> <label class='form-check-label'> <input class='form-check-input' type='radio' name='inlineRadioOptions' id='inlineRadio2' value='option2'>SI</label></div></div><input type='email' class='form-control d-none' id='exampleInputEmail1'> </div></div><div class='row'><div class='form-group col'> <label for='exampleInputEmail1'>Consultorio público</label> <div class='form-control'> <div class='form-check form-check-inline'> <label class='form-check-label'> <input class='form-check-input' type='radio' name='inlineRadioOptions' id='inlineRadio1' value='option1' checked='checked'>NO</label></div><div class='form-check form-check-inline'> <label class='form-check-label'> <input class='form-check-input' type='radio' name='inlineRadioOptions' id='inlineRadio2' value='option2'>SI</label></div></div><input type='email' class='form-control d-none' id='exampleInputEmail1'> </div><div class='form-group col'> <label for='exampleInputEmail1'>Consulta privada</label> <div class='form-control'> <div class='form-check form-check-inline'> <label class='form-check-label'> <input class='form-check-input' type='radio' name='inlineRadioOptions' id='inlineRadio1' value='option1' checked='checked'>NO</label></div><div class='form-check form-check-inline'> <label class='form-check-label'> <input class='form-check-input' type='radio' name='inlineRadioOptions' id='inlineRadio2' value='option2'>SI</label></div></div><input type='email' class='form-control d-none' id='exampleInputEmail1'> </div></div></form><a href='#paciente'>l</a>");
