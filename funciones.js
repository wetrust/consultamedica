...
function crearInformeEcoSegTrim2(){
	...
	var comentario = "Edad ecográfica (Bp50): <strong>" + p50 + "</strong>  Semanas, <small>(La Bp50 no incluiye el perímetro abdominal)</small><br>Fum operacional: " + fur + "<br>Fecha probable de parto: " + fpp;
