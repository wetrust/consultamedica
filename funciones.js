...
$(document).ready(function(){
	...
	$("#imagen\\.oculta\\.home\\.trigger").on("click", function(){
		$("#imagen\\.oculta\\.home\\.uno").fadeIn( 400 ).delay( 5400 ).fadeOut( 400 );
		$("#imagen\\.oculta\\.home\\.dos").delay( 800 ).fadeIn( 400 ).delay( 4600 ).fadeOut( 400 );
		$("#imagen\\.oculta\\.home\\.tres").delay( 1600 ).fadeIn( 400 ).delay( 3800 ).fadeOut( 400 );
		$("#imagen\\.oculta\\.home\\.cuatro").delay( 2400 ).fadeIn( 400 ).delay( 3000 ).fadeOut( 400 );
	});
	...
	$("#cuerpo-uterino").on("change", function(){
		if ($(this).val() == "descripcion adicional en observaciones"){
	...
	$("#administracion\\.interconsultas\\.historic").on("click", function(){
		if ($(this).html().length > 6){
			...
			$.post("https://administrador.crecimientofetal.cl/api/historico", data).done(function(response){
				if (Object.keys(response).length > 0) {
					$.each(response, function(i, val){
						let fila = '<tr><td>' + val.solicitud_id + '</td><td>' + val.solicitud_nombre+ '</td><td>' + val.solicitud_rut + '</td><td>' + val.solicitud_fecha + '</td><td>' + val.solicitud_diagnostico + '</td><td><button class="btn btn-secondary interconsulta-anterior" data-id="' + val.solicitud_id + '">Mirar</button></td></tr>';
						$("#administracion\\.tabla").append(fila);
					});

					$(".interconsulta-anterior").on("click", function(){
						var interconsulta_id = $(this).data("id");
						$('body').append('<div class="modal" tabindex="-1" role="dialog" id="mensaje.dialogo"><div class="modal-dialog modal-lg" role="document"><div class="modal-content"><div class="modal-header"><h5 class="modal-title">Interconsulta</h5></div><div class="modal-body" id="mensaje.body"><p>Cargando Interconsulta</p></div><div class="modal-footer"><button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button></div></div></div></div>');
						$('#mensaje\\.dialogo').modal("show");

						$.get("https://administrador.crecimientofetal.cl/api/obtenerFull/" +interconsulta_id).done(function(response){
							$("#mensaje\\.body").html('<div class="card mb-3"><div class="card-block"><div class="row"><div class="col form-group"><label for="mensaje.nombre.copia">Nombre del paciente</label><input type="text" class="form-control" id="mensaje.nombre.copia" disabled=""></div><div class="col form-group"><label for="mensaje.rut.copia">RUT del paciente</label><input type="text" class="form-control" id="mensaje.rut.copia" disabled=""></div><div class="col form-group"><label for="mensaje.fecha.copia">Fecha de solicitud</label><input type="date" class="form-control" id="mensaje.fecha.copia" disabled=""></div></div><div class="row"><div class="col form-group"><label for="inputEmail4">Ege conocida precozmente</label><div class="custom-control custom-radio custom-control-inline"><input type="radio" id="mensaje.eg.si" value="1" name="mensaje_eg_copia" class="form-check-input" disabled=""><label class="custom-control-label" for="mensaje.eg.si">Si</label></div><div class="custom-control custom-radio custom-control-inline"><input type="radio" id="mensaje.eg.no" value="0" name="mensaje_eg_copia" class="form-check-input" disabled=""><label class="custom-control-label" for="mensaje.eg.no">No</label></div></div><div class="col form-group"><label for="interconsulta.fum.copia">FUM operacional</label><input type="date" disabled="" class="form-control" id="mensaje.fum.copia"></div></div><div class="row"><div class="col form-group"><label for="inputEmail4">Ecografía previa de crecimiento</label><div class="custom-control custom-radio custom-control-inline"><input type="radio" id="mensaje.eco.si" value="1" name="mensaje_eco_copia" class="form-check-input" disabled=""><label class="custom-control-label" for="mensaje.eco.si">Si</label></div><div class="custom-control custom-radio custom-control-inline"><input type="radio" id="mensaje.eco.no" value="0" name="mensaje_eco_copia" class="form-check-input" disabled=""><label class="custom-control-label" for="mensaje.eco.no">No</label></div></div><div class="col form-group"><label for="mensaje.diagnostico">Diagnóstico de referencia para exámen ecográfico</label><input type="text" class="form-control" id="mensaje.diagnostico.copia" disabled=""></div></div><div class="row"><div class="col form-group"><label for="mensaje.ciudad">Ciudad procedencia de la paciente</label><input type="text" class="form-control" id="mensaje.ciudad.copia" disabled=""></div><div class="col form-group"><label for="mensaje.lugar">Lugar de control prenatal</label><input type="text" class="form-control" id="mensaje.lugar.copia" disabled=""></div></div><div class="row"><div class="col form-group"><label for="mensaje.profesional">Profesional referente </label><div class="custom-control custom-radio custom-control-inline"><input type="radio" id="mensaje.profesional.matrona" disabled="" value="Matrona" name="mensaje_profesional_copia" class="form-check-input" checked=""><label class="custom-control-label" for="mensaje.profesional.matrona">Matrona</label></div><div class="custom-control custom-radio custom-control-inline"><input type="radio" disabled="" id="mensaje.profesional.medico" value="Médico" name="mensaje_profesional_copia" class="form-check-input"><label class="custom-control-label" for="mensaje.profesional.medico">Médico</label></div></div><div class="col form-group"><label for="mensaje.profesional.nombre">Nombre del profesional referente</label><input type="text" class="form-control" id="mensaje.profesional.nombre.copia" disabled=""></div></div><div class="row"><div class="col form-group"><label for="mensaje.email">Correo electrónico de referencia</label><input type="email" class="form-control" id="mensaje.email.copia" disabled=""></div><div class="col form-group"><label for="mensaje.telefono">Fono</label><input type="number" class="form-control" id="mensaje.telefono.copia" disabled=""></div></div><div class="row"><div class="col form-group"><label for="mensaje.para">Correo electrónico de contrarreferencia</label><input type="email" class="form-control" id="mensaje.para.copia" disabled=""></div></div></div></div><div class="card mb-3"><div class="card-block"><h6>Responder a solicitud de exámen ecográfico para crecimiento</h6><div class="row"><div class="col-6 form-group"><label for="mensaje.respuesta.proceder">¿Solicitud relacionada con crecimiento fetal?</label><select class="form-control" disabled="" id="mensaje.respuesta.proceder"><option value="si">Si</option><option value="no">No</option></select></div></div><div class="row"><div class="col form-group"><label for="mensaje.respuesta.fecha">Fecha evaluación de interconsulta ecográfica</label><input type="date" class="form-control" disabled="" id="mensaje.respuesta.fecha"></div><div class="col form-group"><label for="mensaje.respuesta.fechacitacion">Fecha de citacion, próximo exámen ecográfico</label><input type="date" class="form-control" disabled="" id="mensaje.respuesta.fechacitacion"></div></div><div class="row"><div class="col form-group"><label for="mensaje.respuesta.comentarios" class="bg-primary text-white px-1">Comentarios y observaciones respecto a solicitud ecográfica</label><input type="text" class="form-control" disabled="" id="mensaje.respuesta.comentarios"></div></div><h5 id="mensaje.titulo" class="text-center m-3">Resumen exámen ecográfico de biometría y flujometría Doppler Materno / Fetal</h5><input type="hidden" class="form-control" id="mensaje.respuesta.id" value="8"><div class="row" id="mensaje.respuesta.pfe.div"><div class="col form-group"><label for="mensaje.respuesta.pfe"><strong>A.- Biometría ecográfica:</strong><br>Peso fetal estimado</label><input type="number" class="form-control" disabled="" id="mensaje.respuesta.pfe"></div><div class="col form-group"><label for="mensaje.respuesta.pfe.percentil">&nbsp;<br>Percentil</label><input type="number" class="form-control" disabled="" id="mensaje.respuesta.pfe.percentil"></div></div><div class="row" id="mensaje.respuesta.liquido.div"><div class="col form-group"><label for="mensaje.respuesta.liquido">Líquido amniótico</label><select class="form-control" disabled="" id="mensaje.respuesta.liquido"><option value="normal">Normal</option><option value="pha">PHA</option><option value="oha">OHA</option></select></div><div class="col form-group"><label for="mensaje.respuesta.bvm">BVM</label><input type="number" class="form-control" disabled="" id="mensaje.respuesta.bvm"></div></div><div class="row" id="mensaje.respuesta.uterinas.div"><div class="col form-group"><label for="mensaje.respuesta.uterinas"><strong>B.- Flujometría Doppler</strong><br>IP. Promedio uterinas</label><input type="text" class="form-control" disabled="" id="mensaje.respuesta.uterinas"></div><div class="col form-group"><label for="mensaje.respuesta.uterinas.percentil">&nbsp;<br>Percentil</label><input type="number" class="form-control" disabled="" id="mensaje.respuesta.uterinas.percentil"></div></div><div class="row" id="mensaje.respuesta.umbilical.div"><div class="col form-group"><label for="mensaje.respuesta.umbilical">IP. Arteria umbilical</label><input type="text" class="form-control" disabled="" id="mensaje.respuesta.umbilical"></div><div class="col form-group"><label for="mensaje.respuesta.umbilical.percentil">Percentil</label><input type="number" class="form-control" disabled="" id="mensaje.respuesta.umbilical.percentil"></div></div><div class="row" id="mensaje.respuesta.cm.div"><div class="col form-group"><label for="mensaje.respuesta.cm">IP. Cerebral media</label><input type="text" class="form-control" disabled="" id="mensaje.respuesta.cm"></div><div class="col form-group"><label for="mensaje.respuesta.cm.percentil">Percentil</label><input type="number" class="form-control" disabled="" id="mensaje.respuesta.cm.percentil"></div></div><div class="row" id="mensaje.respuesta.cmau.div"><div class="col form-group"><label for="mensaje.respuesta.cmau">Cuociente CM / AU</label><input type="text" class="form-control" disabled="" id="mensaje.respuesta.cmau"></div><div class="col form-group"><label for="mensaje.respuesta.cmau.percentil">Percentil</label><input type="number" class="form-control" disabled="" id="mensaje.respuesta.cmau.percentil"></div></div><div class="row" id="mensaje.respuesta.hipotesis.div"><div class="col form-group"><label for="mensaje.respuesta.hipotesis">Hipótesis diagnóstica</label><input type="text" class="form-control" disabled="" id="mensaje.respuesta.hipotesis"></div></div><div class="row" id="mensaje.respuesta.rciu.div"><div class="col form-group"><label for="mensaje.respuesta.rciu">De ser RCIU, categorización según protocolo adjunto (Figuera, Gratacos y col.)</label><select class="form-control" disabled="" id="mensaje.respuesta.rciu"><option value="G I">G I</option><option value="G II">G II</option><option value="g III">G III</option><option value="g IV">G IV</option></select></div><div class="row" id="mensaje.respuesta.lugar.div"><div class="col form-group"><label for="mensaje.respuesta.lugar"><strong>Próximo control</strong> Lugar:</label><input type="text" class="form-control" disabled="" id="mensaje.respuesta.lugar"></div><div class="col form-group"><label for="mensaje.respuesta.controlfecha">Fecha</label><input type="date" class="form-control" disabled="" id="mensaje.respuesta.controlfecha"></div></div><div class="row" id="mensaje.respuesta.comentariosexamen.div"><div class="col form-group"><label for="mensaje.respuesta.comentariosexamen">Comentarios de exámen</label><input type="text" class="form-control" id="mensaje.respuesta.comentariosexamen" disabled=""></div><div class="col form-group"><label for="mensaje.respuesta.ecografista">Ecografista</label><input type="text" class="form-control" id="mensaje.ecografista" disabled=""></div></div></div></div>');
							$("#mensaje\\.respuesta\\.id").val(response.solicitud_id);
							...
							$("input[name=mensaje_eg_copia][value=" + response.solicitud_eg+ "]").prop('checked', true);
							$("#mensaje\\.fum\\.copia").val(response.solicitud_fum),
							$("input[name=mensaje_eco_copia][value=" + response.solicitud_eco + "]").prop('checked', true);
							...
							$("#mensaje\\.respuesta\\.fechacitacion").val(response.fechacitacion);
							$("#mensaje\\.respuesta\\.comentarios").val(response.comentarios);
							$("#mensaje\\.respuesta\\.pfe").val(response.pfe);
							$("#mensaje\\.respuesta\\.pfe\\.percentil").val(response.pfe_percentil);
							$("#mensaje\\.respuesta\\.liquido").val(response.liquido);
							$("#mensaje\\.respuesta\\.bvm").val(response.bvm);
							$("#mensaje\\.respuesta\\.uterinas").val(response.uterinas);
							$("#mensaje\\.respuesta\\.uterinas\\.percentil").val(response.uterinas_percentil);
							$("#mensaje\\.respuesta\\.umbilical").val(response.umbilical);
							$("#mensaje\\.respuesta\\.umbilical\\.percentil").val(response.umbilical_percentil);
							$("#mensaje\\.respuesta\\.cm").val(response.cm);
							$("#mensaje\\.respuesta\\.cm\\.percentil").val(response.cm_percentil);
							$("#mensaje\\.respuesta\\.cmau").val(response.cmau);
							$("#mensaje\\.respuesta\\.cmau\\.percentil").val(response.cmau_percentil);
							$("#mensaje\\.respuesta\\.hipotesis").val(response.hipotesis);
							$("#mensaje\\.respuesta\\.rciu").val(response.rciu);
							$("#mensaje\\.respuesta\\.lugar").val(response.lugar);
							$("#mensaje\\.respuesta\\.controlfecha").val(response.controlfecha);
							$("#mensaje\\.respuesta\\.comentariosexamen").val(response.comentariosexamen);
							$("#mensaje\\.ecografista").val(response.ecografista);
						});
