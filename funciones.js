...
function crearInformeEcoSegTrim2(){
	...
	var comentario = "Edad ecográfica (Bp50): <strong>" + p50 + " Semanas</strong>, <small>( La Biometría p50 no incluye el perímetro abdominal )</small><br>Fum operacional: " + fur + "<br>Fecha probable de parto: " + fpp;
