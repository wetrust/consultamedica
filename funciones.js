				...
				if (Object.keys(response).length > 0) {
					...
					$(".interconsulta-anterior").on("click", function(){
						...
						$.post("https://administrador.crecimientofetal.cl/api/historico", data).done(function(response){
							...
							$("#mensaje\\.nombre\\.copia").val("");
							$("#mensaje\\.rut\\.copia").val("");
							$("#mensaje\\.fecha\\.copia").val("");
							$("#mensaje_eg_copia").val("");
							$("#mensaje\\.fum\\.copia").val("");
							$("#mensaje_eco_copia").val("");
							$("#mensaje\\.diagnostico\\.copia").val("");
							$("#mensaje\\.ciudad\\.copia").val("");
							$("#mensaje\\.lugar\\.copia").val("");
							$("#mensaje_profesional_copia").val("");
							$("#mensaje\\.profesional\\.nombre\\.copia").val("");
							$("#mensaje\\.email\\.copia").val("");
							$("#mensaje\\.telefono\\.copia").val("");
							$("#mensaje\\.para\\.copia").val("");
							$("#mensaje.respuesta.proceder").val("");
							$("#mensaje.respuesta.fecha").val("");
							$("#mensaje.respuesta.fechacitacion").val("");
							$("#mensaje.respuesta.comentarios").val("");
							$("#mensaje.respuesta.id").val("");
							$("#mensaje.respuesta.pfe").val("");
							$("#mensaje.respuesta.pfe.percentil").val("");
							$("#mensaje.respuesta.liquido").val("");
							$("#mensaje.respuesta.bvm").val("");
							$("#mensaje.respuesta.uterinas").val("");
							$("#mensaje.respuesta.uterinas.percentil").val("");
							$("#mensaje.respuesta.umbilical").val("");
							$("#mensaje.respuesta.umbilical.percentil").val("");
							$("#mensaje.respuesta.cm").val("");
							$("#mensaje.respuesta.cm.percentil").val("");
							$("#mensaje.respuesta.cmau").val("");
							$("#mensaje.respuesta.cmau.percentil").val("");
							$("#mensaje.respuesta.hipotesis").val("");
							$("#mensaje.respuesta.rciu").val("");
							$("#mensaje.respuesta.lugar").val("");
							$("#mensaje.respuesta.controlfecha").val("");
							$("#mensaje.respuesta.comentariosexamen").val("");
							$("#mensaje.ecografista").val("");
						});
