...
$( '#modalInfEcoGine' ).on( 'click', function() {
	$('#popupTitle').html("Datos para evaluación ecográfica de primer trimestre");
	//remueve los botones de imprimir en caso de que estén
	$( '#impEcoObsSegTrim2').remove();
	$( '#impEcoObsSegTrim1').remove();
...
function crearInformeEcoGine(){
	var InformeString = "<div class='container-fluid'> <h3 class='page-header text-center'>ECOGRAFÍA GINECOLÓGICA</h3></div><span style='border-top: 1px solid #000;width: 100% !important;display: block;border-bottom: 2px solid #000;padding-top: 2px;margin-bottom:15px;'></span><div class='container-fluid'> <p><strong>Paciente Sra. (Srta.): </strong>:PACIENTE</p><p><strong>Edad Materna: </strong> :EDADMATERNA años.</p><p><strong>Fecha de Exámen: </strong>:FEXAMEN</p><p><strong> ID Paciente: </strong>:IDPACIENTE</p><p><strong> Motivo de exámen: </strong> :MOTIVO</p><p><strong> Patología Obstétrica: </strong>:PATOLOGIAOBSTETRICA</p></div><div class='container-fluid'> <p><strong style='color:#045dab;'>ANTECEDENTES</strong> </p><p><strong>FUM: </strong> :FUM</p></div><div class='container-fluid'> <p><strong style='color:#045dab;'>DESCRIPCIÓN</strong> </p><p class='lead'><strong>Fecha de exámen :</strong>LINEA1 <br><strong>Útero :</strong>LINEA2 <br><strong>Endometrio :</strong>LINEA3 <br><strong>Anexo Izquierdo :</strong>LINEA4 <br><strong>Ovario Izquierdo :</strong>LINEA5 <br><strong>Anexo Derecho :</strong>LINEA6 <br><strong>Ovario Derecho :</strong>LINEA7 <br><strong>Douglas :</strong>LINEA8</p><p></p><p></p><p></p><p></p></div><div class='container-fluid'> <p><strong style='color:#045dab;'>COMENTARIOS Y OBSERVACIONES</strong> </p><p style='max-width: 700px;text-align: justify;'>:COMENTARIO</p></div><div class='container-fluid'> <p class='text-right top40'>Ecografista Dr(a): <strong>:ECOGRAFISTA</strong> </p><span style='border-top: 1px solid #000;width: 100% !important;display: block;'></span> <p>Fecha Informe: :DATEINFORME</p><span style='border-top: 2px solid #000;width: 100% !important;display: block;'></span> <p class='pie-pagina' style='border-bottom:0;'><strong>El software tiene por objetivo favorecer el análisis preliminar de los datos obtenidos en el exámen ecográfico, la interpretación clínica de los mismos, es responsabilidad exclusiva de quien realiza y certifica este documento.</strong> </p></div>";

    var LINEA2 = $("input[name='respuesta_utero_ginecologica']").val();
    var LINEA3 = $("input[name='respuesta_endometrio']").val();
    var LINEA4 = $("input[name='respuesta_anexo_izquierdo_ginecologica']").val();
    var LINEA5 = $("input[name='respuesta_ovario_izquierdo']").val();
    var LINEA6 = $("input[name='respuesta_anexo_derecho_ginecologica']").val();
	var LINEA7 = $("input[name='respuesta_ovario_derecho']").val();
	var LINEA8 = $("input[name='respuesta_douglas_ginecologica']").val();
	...
	InformeString = InformeString.replace(":EDADMATERNA", edadmaterna);
	InformeString = InformeString.replace(":FEXAMEN", fexamen);
	InformeString = InformeString.replace(":LINEA1", fexamen);
	InformeString = InformeString.replace(":LINEA2", LINEA2);
	InformeString = InformeString.replace(":LINEA3", LINEA3);
	InformeString = InformeString.replace(":LINEA4", LINEA4);
	InformeString = InformeString.replace(":LINEA5", LINEA5);
