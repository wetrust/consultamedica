...
function crearInformeEcoPrimTrim(){
	...
	var LINEA8 = '';
        ...
        if ($('#lcn').val() > 0) {
            ...
            LINEA8 = "Edad gestacional estimada " + $("#lcnPct").html() + " semanas por LCN.<br>";
        }
	var LINEA13 = '';
