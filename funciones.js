...
$( '#modalPreInfEcoObsSegTrim1' ).on( 'click', function() {
	...
	//añadir boton de imprimir
	$('#comentarios-eco-dos-inf-uno').val($('#comentarios-eco-dos-generico').val());
