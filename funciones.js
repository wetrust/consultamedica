...
function crearInformeEcoSegTrim1(){
  ...
  anatomiaFetalString = anatomiaFetalString + " " + $('#comentarios-anatomia-informe-eg-texto').val();
	...
	var data = {
  	nombre: $( '#nombre-paciente').val(),
    edad_materna: $( "select[name='edad_materna']").val(),
    fecha_examen: $( "input[name='fee']").val(),
    id: $( '#id-paciente').val(),
    motivo_examen: $( '#motivo-examen option:selected').text(),
    patologia: $( '#patologiaObstetricaUno option:selected').text(),
    fecha_fum: $( "input[name='fum']").val(),
    edad_gestacional: $( "input[name='eg']").val(),
    fecha_fpp: $( "input[name='fpp']").val(),
    ecografista: $('#ecografista option:selected').text(),
    dbp: document.getElementById("dbp").value,
    dbp_pct: document.getElementById("dbpPct").value,
    dbp_rango: document.getElementById("dbpRango").value,
    dof: document.getElementById("dof").value,
    dof_pct: document.getElementById("dofPctRpt").value,
    dof_rango: document.getElementById("dofRango").value,
    cc: document.getElementById("cc").value,
    cc_pct: document.getElementById("ccPctRpt").value,
    cc_rango: document.getElementById("ccRango").value,
    ca: document.getElementById("ca").value,
    ca_pct: document.getElementById("caPctRpt").value,
    ca_rango: document.getElementById("caRango").value,
    lf: document.getElementById("lf").value,
    lf_pct: document.getElementById("lfPctRpt").value,
    lf_rango: document.getElementById("lfRango").value,
    pfe: $( '#pfe').val(),
    pfe_pct: percentilPeso,
    pfe_rango: $( '#pfeRango').val(),
    ccca:document.getElementById("ccca").value,
    ccca_pct:document.getElementById("cccaPctVal").value,
    ccca_rango:document.getElementById("cccaRango").value,
    ic: $( '#dof-dbp').val(),
    actividad_cardiaca: actCard,
    movimientos_corporales: movCorp,
    presentacion: document.getElementById("presentacion").value,
    dorso: document.getElementById("dorso").value,
    frecuencia: document.getElementById("fcf").value,
    anatomia: anatomiaFetalString,
    insercion: document.getElementById("incersion").value,
    ubicacion: document.getElementById("ubicacion").value,
    grado: document.getElementById("grado-placenta").value,
    cordon: document.getElementById("cordon").value,
    vasos: document.getElementById("vasos").value,
    liquido: document.getElementById("liq-cualitativo-eco").value,
		bvm: document.getElementById("bvmEcoDos").value,
