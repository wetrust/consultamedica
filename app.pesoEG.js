...
function generarDatos(){
    ...
    datos += '<div class="row"><div class="col-6"></div><div class="col-6"><label for="relPesoEgeAjustOms"><small>Relación PEF / EG</small></label>'
    datos += '<input type="text" class="form-control" id="relPesoEgeAjustOms" disabled></div></div>'

    datos += '<label for="sexsexsex">Sexo Fetal</label><br><div class="btn-group btn-group-toggle" data-toggle="buttons"><label class="btn btn-outline-secondary"><input type="radio" name="sexsexsex" value="des"> Desconocido</label><label class="btn btn-outline-secondary"><input type="radio" name="sexsexsex" value="men"> Masculino</label><label class="btn btn-outline-secondary"><input type="radio" name="sexsexsex" value="wom"> Femenino</label></div><div class="row mt-3 justify-content-md-center"><div class="col-10 mb-2 mt-2 text-center"><img src="img/PFE.png" alt="letrero" id="letrero" class="img-fluid d-none"><a class="btn btn-outline-secondary active d-none" href="#ecoDoppler" id="goto.doppler.grafico">Flujometría Doppler Fetal</a><br><a id="linkCalculadora" class="card-link d-none" target="_blank" href="https://fetalmedicinebarcelona.org/calc/">Ver calculadora fetal barcelona</a></div></div>'
