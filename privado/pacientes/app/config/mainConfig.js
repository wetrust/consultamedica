export class mainConfig {
    ...
    static filterElements = [
        {nombre:"Fecha", name: "filtro_fecha_desde", filter:"paciente_fee", placeholder: "", type:"date", special: false, advanced: true, config:""},
        {nombre:"Fecha", name: "filtro_fecha_hasta", filter:"paciente_fee", placeholder: "", type:"date", special: false, advanced: true, config:""},
        {nombre:"Rut", name: "filtro_rut", filter:"paciente_rut", placeholder: "Por RUT", type:"text", special: false, advanced: true, config:""},
        {nombre:"Nombre", name: "filtro_nombre", filter:"paciente_nombre", placeholder: "Por Nombre", type:"text", special: false, advanced: true, config:""},
        {nombre:"Apellido", name: "filtro_apellido", filter:"paciente_apellido", placeholder: "Por Apellido", type:"text", special: false, advanced: true, config:""},
        {nombre:"Centro", name: "filtro_centro", filter:"paciente_centro", placeholder: "Por centro", type:"text", special: true, advanced: false, config:"centro"},
        {nombre:"Tipo", name: "filtro_tipo", filter:"paciente_tipo", placeholder: "Por Tipo", type:"text", special: true, advanced: true, config:"", data:["Ecografía obstétrica precoz", "Evaluación crecimiento", "Flujometría Doppler", "Ecografía Ginecológica"]}
    ]
}