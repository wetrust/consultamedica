export class mainConfig {
    ...
    static filterElements = [
        {nombre:"Fecha", name: "filtro_fecha", filter:"paciente_fee", placeholder: "", type:"date", special: false},
        {nombre:"Rut", name: "filtro_rut", filter:"paciente_rut", placeholder: "Por RUT", type:"text", special: false},
        {nombre:"Nombre", name: "filtro_nombre", filter:"paciente_nombre", placeholder: "Por Nombre", type:"text", special: false},
        {nombre:"Apellido", name: "filtro_apellido", filter:"paciente_apellido", placeholder: "Por Apellido", type:"text", special: false},
        {nombre:"Centro", name: "filtro_centro", filter:"paciente_centro", placeholder: "Por centro", type:"text", special: true, config:"centro"},
        {nombre:"Tipo", name: "filtro_tipo", filter:"paciente_tipo", placeholder: "Por Tipo", type:"text", special: true, config:"lcontrol"}
    ]
}